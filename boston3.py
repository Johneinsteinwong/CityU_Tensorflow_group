...
input categorical features as numeric input
"""
...
train_dataset = train[['CRIM','ZN','INDUS','NOX','RM','AGE','DIS','TAX','PTRATIO','B','LSTAT','CHAS','RAD']].as_matrix().astype(np.float32)
valid_dataset = valid[['CRIM','ZN','INDUS','NOX','RM','AGE','DIS','TAX','PTRATIO','B','LSTAT','CHAS','RAD']].as_matrix().astype(np.float32)
test_dataset = test[['CRIM','ZN','INDUS','NOX','RM','AGE','DIS','TAX','PTRATIO','B','LSTAT','CHAS','RAD']].as_matrix().astype(np.float32)
